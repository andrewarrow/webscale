div p-0 
  ...
  div flex flex-col md:flex-row space-x-9 items-start justify-center
    div w-full md:w-1/2
      ...
      div mt-9 relative text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]
        <div class="group border-2 w-[9rem] h-60 z-0 absolute left-0"><div class="hidden group-hover:block">This is left side</div></div>
        <div style="pointer-events: none;" class="bg-black w-[1rem] h-60 z-0 absolute left-[9rem]"></div>
        <div class="group border-2 w-[11rem] h-60 z-0 absolute left-[10rem]"><div class="hidden group-hover:block">This is middle</div></div>
