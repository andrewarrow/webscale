div p-0 
  ...
  div flex flex-col md:flex-row space-x-9 items-start justify-center
    div w-full md:w-1/2
      ...
      div mt-9 relative
        <div style="pointer-events: none;" class="border-2 w-96 h-60 z-0 absolute"></div>
        <video class="z-1 h-60" controls autoplay muted loop src="https://i.imgur.com/fA99U7n.mp4"/>
      div mt-9
